...
class RoleMapperApiVertxProxyHandler(private val vertx: Vertx, private val service: RoleMapperApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
            ...
            when (action) {
                ...
                "realmGroupsIdRoleMappingsGet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmGroupsIdRoleMappingsGet(realm,id,context)
                ...
                "realmGroupsIdRoleMappingsRealmAvailableGet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmGroupsIdRoleMappingsRealmAvailableGet(realm,id,context)
                ...
                "realmGroupsIdRoleMappingsRealmCompositeGet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmGroupsIdRoleMappingsRealmCompositeGet(realm,id,briefRepresentation,context)
                        val payload = JsonArray(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmGroupsIdRoleMappingsRealmDelete" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmGroupsIdRoleMappingsRealmDelete(realm,id,roleRepresentation,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmGroupsIdRoleMappingsRealmGet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmGroupsIdRoleMappingsRealmGet(realm,id,context)
                        val payload = JsonArray(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmGroupsIdRoleMappingsRealmPost" -> {
                    ...
                    val roleRepresentation:kotlin.Array<RoleRepresentation> = Gson().fromJson(roleRepresentationParam.encode()
                            , object : TypeToken<kotlin.collections.List<RoleRepresentation>>(){}.type)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmGroupsIdRoleMappingsRealmPost(realm,id,roleRepresentation,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmUsersIdRoleMappingsGet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmUsersIdRoleMappingsGet(realm,id,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmUsersIdRoleMappingsRealmAvailableGet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmUsersIdRoleMappingsRealmAvailableGet(realm,id,context)
                        val payload = JsonArray(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmUsersIdRoleMappingsRealmCompositeGet" -> {
                    ...
                    val briefRepresentation = ApiHandlerUtils.searchStringInJson(params,"briefRepresentation")?.toBoolean()
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmUsersIdRoleMappingsRealmCompositeGet(realm,id,briefRepresentation,context)
                        val payload = JsonArray(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmUsersIdRoleMappingsRealmDelete" -> {
                    ...
                    val roleRepresentation:kotlin.Array<RoleRepresentation> = Gson().fromJson(roleRepresentationParam.encode()
                            , object : TypeToken<kotlin.collections.List<RoleRepresentation>>(){}.type)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmUsersIdRoleMappingsRealmDelete(realm,id,roleRepresentation,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmUsersIdRoleMappingsRealmGet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmUsersIdRoleMappingsRealmGet(realm,id,context)
                        val payload = JsonArray(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "realmUsersIdRoleMappingsRealmPost" -> {
                    ...
                    val roleRepresentation:kotlin.Array<RoleRepresentation> = Gson().fromJson(roleRepresentationParam.encode()
                            , object : TypeToken<kotlin.collections.List<RoleRepresentation>>(){}.type)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.realmUsersIdRoleMappingsRealmPost(realm,id,roleRepresentation,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
